...
This skill provides a systematic framework for pricing strategy based on Dima Melnik's research and methodologies. It covers two main areas:

1. **Price Offer Design** - How to structure pricing pages and price tables for maximum conversion
2. **Price Increase Strategy** - How to communicate price increases to existing customers without losing them
...
- Structuring SaaS/subscription tiers
- Writing price increase email sequences
...
### Step PI-1: Game Plan (Customer Migration Table)

- [ ] Create customer migration table
- [ ] Segment customers by plan/tier
- [ ] Define old price → new price for each segment
- [ ] Calculate % increase per segment
...
### Step PI-2: Personalized Discount

- [ ] Calculate tenure-based discount
...
- [ ] Check if new price crosses psychological border
- [ ] Adjust to stay below border if possible
...
### Step PI-6: First Impression (Email Subject Line)

- [ ] Use POSITIVE framing in subject line
- [ ] Avoid "Price Increase" in subject
...
- [ ] List 5-10 improvements made since last price
...
### Step PI-8: Value Increase

- [ ] Consider offering MORE value instead of just raising price
...
### Step PI-9: Social Proof

- [ ] Include customer testimonial about value
...
### Step PI-10: Postpone in Time

- [ ] Offer delayed implementation (60-90 days)
...
## Phase B: Price Offer Design (18 Tactics)
...
### Tactic PO-1: Segment-Specific Offers

- [ ] Create different offers for different segments
...
### Tactic PO-2: Multiple Price Options
...
### Tactic PO-3: Max 4 Packages

- [ ] Limit to 3-4 pricing tiers
...
- [ ] De-emphasize cheapest tier visually
- [ ] Smaller box, less prominent position
- [ ] Gray/muted colors

**Goal:** Make cheap option look like "starter" not "real" option.

### Tactic PO-5: Middle Option is Key

- [ ] Target 50-65% of customers choosing middle tier
- [ ] Make middle option visually prominent
- [ ] Best value positioning

**Goldilocks Effect:** Most people avoid extremes.

### Tactic PO-6: Substitution Effect

- [ ] Add "decoy" option to make target look better
- [ ] Decoy should be slightly worse deal than target

**Example:**
| Basic | **Pro (Target)** | Pro+ (Decoy) |
|-------|------------------|--------------|
| $29 | **$49** | $59 |
| 10 features | **25 features** | 27 features |

Pro+ adds only 2 features for $10 more → Pro looks like best value.

### Tactic PO-7: Compare Key Features Only

- [ ] Max 5-7 features in comparison table
- [ ] Focus on differentiating features
- [ ] Remove features common to all tiers

**❌ Bad:** 20+ feature comparison (overwhelming)
**✅ Good:** 5-7 KEY differentiators

### Tactic PO-8: No-Brainer Smart Choice

- [ ] Make one option obviously the best deal
...
### Tactic PO-9: Seductive Pricing

- [ ] Use psychological pricing ($199 vs $200)
- [ ] End in 9 or 7
...
### Tactic PO-10: Start with Big Guns

- [ ] Show highest-value features first
...
### Tactic PO-11: Package Names = Buyer Profiles

- [ ] Name packages after target users
- [ ] Customers self-select into "their" tier

**Examples:**
| Generic Names | Profile Names |
|---------------|---------------|
| Basic, Pro, Enterprise | Solo, Team, Agency |
| Starter, Growth, Scale | Freelancer, Studio, Enterprise |

### Tactic PO-12: Small Font for Prices

- [ ] Use smaller font size for price numbers
- [ ] Larger font for features/benefits

**Visual hierarchy:** Benefits > Price

### Tactic PO-13: Dream Outcome Summary

- [ ] Write 1-line summary of what each tier achieves
...
### Tactic PO-14: Anchor with High Number

- [ ] Show high number before price
...
### Tactic PO-15: Highlight Preferred Option

- [ ] Use visual emphasis on target tier
...
### Tactic PO-16: Minimize Perceived Cost

- [ ] Show monthly price even for annual billing
...
### Tactic PO-17: Crown Jewel Logos

- [ ] Show most impressive customer logos
...
### Tactic PO-18: Add-ons

- [ ] Offer optional add-ons after tier selection
...
## Core Philosophy: Design Around the Price
...
## Advanced Visual Design Tactics
...
> Designing a pricing page is like building a runway for a plane at night.
> The customer is a pilot in fog with no absolute sense of value.
> **Price anchors and decoys** are landing lights on both sides — they don't tell absolute position, but clearly show where to land safely (buy).
...
## Email Templates for Price Increase
...
- [ ] New pricing tested on new customers (PI-4)
...
- [ ] Social proof included (PI-9)
- [ ] Delayed implementation offered (PI-10)
...
- [ ] Profile-based names (PO-11)
- [ ] Small font for prices (PO-12)
- [ ] Dream outcome summaries (PO-13)
...
- "Price Increase" in email subject
- Big bang price migration
- No loyalty discount for long-term customers
...
- **Wave migration:** -25% churn vs big bang
- **Loyalty discounts:** -20% customer complaints
