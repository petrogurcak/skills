...
- Launching new product/service and need positioning strategy
...
1. **Best Quality** - Premium craftsmanship, superior materials
   - Example: Stradivarius violins
   - When: You can objectively deliver highest quality

2. **Best Value Ratio** - Optimal quality-to-price balance
   - Example: IKEA, DM Drogerie
   - When: You compete on efficiency, not luxury

3. **Luxury/Prestige** - Status, exclusivity, brand equity
   - Example: Patek Philippe, Calvin Klein
   - When: Customers buy for social signaling

4. **Essential/Must-Have** - Users cannot live without it
   - Example: Google Apps, MailChimp
   - When: You've achieved product-market fit + habit formation
...
#### Step 2.1: Research (Copy-First Approach)
...
#### Step 2.2: Write Using Framework
...
4. Success = 80%+ can explain accurately
...
4. Interview new customers every month
5. Reassess positioning every 6-12 months
...
1. **Writing before researching** → Corporate jargon, not customer language
2. **Testing without clarity first** → Optimizing unclear message = polishing turd
3. **Homepage-only placement** → 75-80% of users never see it
4. **Feature-focused instead of benefit-focused** → "We have X" vs. "You get Y"
5. **Trying to appeal to everyone** → Specific beats generic
6. **Not testing** → 54% of companies skip this, most fail
7. **Skipping internal alignment** → Team confusion → customer confusion
...
- SIMS3: +128% registration (specific benefits)
- InfusionSoft: +40.6% conversion (reduced navigation)
...
## Checklist for Complete UVP Optimization

Copy this to TodoWrite when starting:

☐ Phase 1: Choose strategic position (Best Quality/Value/Luxury/Essential)
☐ Phase 2.1: Conduct customer interviews (40+ emails)
☐ Phase 2.1: Survey new customers (within 24 hours)
☐ Phase 2.1: Get expert feedback (5-10 reviewers)
☐ Phase 2.1: Align team internally
☐ Phase 2.2: Choose formulation framework
☐ Phase 2.3: Write 50+ headline variations
☐ Phase 2.3: Internal testing of top 10
☐ Phase 3: Run five-second test (target 80%+ clarity)
☐ Phase 3: A/B test top 3-5 headlines
