...
This skill provides frameworks for systematic, data-driven growth using methodologies from Sean Ellis & Morgan Brown's "Hacking Growth". Use when you need to prioritize experiments and drive sustainable growth.
...
```
NO GROWTH WITHOUT PRODUCT-MARKET FIT
...
### Framework 1: Must-Have Survey (PMF Validation)
...
**Interpretation:**
| Very Disappointed % | PMF Status | Action |
|--------------------|------------|--------|
| 40%+ | PMF achieved | Scale growth |
| 25-40% | Almost there | Improve core value |
...
### Framework 2: Growth Hacking Process
...
- Thursday-Friday: Implementation and launch
...
- Document ALL learnings (wins and failures)
- Share across team
- Feed insights back into Analyze phase
- Update experiment backlog
...
**Skipping PMF validation:**
"Let's scale ads!" with no PMF data → Burning money.

**Over-optimizing for wrong metric:**
Increasing signups while ignoring activation → Vanity metrics.
...
Serial testing is slow → Run parallel experiments on different funnels.
...
- Must-Have Survey <25% → Product problem, not growth problem
- All experiments failing → Wrong hypothesis, wrong metric
- No clear North Star → Align team first
- No data infrastructure → Can't measure = can't grow
