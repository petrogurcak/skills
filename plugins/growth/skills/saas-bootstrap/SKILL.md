...
This skill helps bootstrapped founders build sustainable SaaS businesses using frameworks from Rob Walling's "The SaaS Playbook". Use when you're building without external funding and need to be strategic about what to build and how to grow.
...
### Framework 1: Stair Step Method of Entrepreneurship
...
- Psychological safety to take bigger swings

---

### Framework 2: 3 High / 3 Low Metrics
...
- E-commerce merchants (track ROI easily)
...
### Phase 2: For Step 1 Products

1. Find marketplace with demand (WordPress, Shopify, etc.)
2. Identify problem people are paying to solve
3. Build simple solution
4. Launch and learn
5. Support customers, iterate
...
**Going straight to Step 3:**
"I'll build a big SaaS" without experience → High failure rate.

**Ignoring churn:**
"I'll grow past it" → Leaky bucket never fills.

**Competing on price:**
"I'll be cheaper" → Race to bottom, unsustainable CAC.

**Targeting consumers:**
"Everyone needs this!" → Low willingness to pay, high support.

**No niche:**
"It's for all businesses" → Can't reach anyone effectively.
...
- Churn > 10% monthly → Product or market problem
- CAC > ACV → Unsustainable
- No expansion possible → Limited LTV
- Can't reach customers affordably → Wrong market
- 6+ months, no traction → Pivot or step back
...
- Want to own 100%
- Prefer slow, sustainable growth
...
4. `growth-hacking` → Systematic acquisition
5. `saas-bootstrap` → 3H/3L monitoring
