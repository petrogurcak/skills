# Landing Page Expert Review Template

**Duration:** ~20-30 minutes
**Focus:** Conversion-optimized pages (sales/lead gen)
**Framework:** Blueprint / Triáda / PROTTO structure
...
## LANDING PAGE STRUCTURE (Blueprint/PROTTO)

### Section 1: Hook / PRObuď

**User provides:** Hook headline + subheading
...
- [ ] Above fold entirely (no scrolling needed)
...
**Challenge question:**
"Pokud user přišel z [zdroj], očekává [promise]. Delivers landing page?"

---

### Section 2: Problem / PROblem

**User provides:** Problem statement section
...
**Example:**
❌ "Marketing is hard"
✅ "70% of your leads abandon because your forms have 12 fields. That's $X,000 lost monthly."

---

### Section 3: Solution / PROduktu

**User provides:** How your product solves problem
...
- [ ] Visual support (screenshot, diagram, video)
...
### Section 4: Proof / PROlom

**User provides:** Social proof, testimonials, case studies
...
- [ ] Video testimonials if possible (2x trust)
...
**Challenge:**
"Jsou testimonials konkrétní nebo generic 'Great product!'?"

---

### Section 5: Features / PROperties (optional)
...
### Section 6: Objections / PROtection

**User provides:** Guarantee, risk reversal, FAQ
...
### Section 7: CTAs (Multiple Throughout)
...
- [ ] CTA at end (final decision point)
...
**Challenge:**
"Kolik scroll distance mezi CTAs? Max 2-3 screen heights."

---

## DESIGN SPECIFIC TO LANDING PAGES

### Navigation

**Critical decision:** Navigation ON or OFF?
...
**If nav present:**
'Každý menu link je exit path. InfusionSoft odstranili nav = +40.6% conversion. Unless high-ticket B2B product, recommend remove.'"
...
**Challenge:**
"Jaká je average ticket value? <$100 = test short, >$1000 = likely need long."
...
**Landing page priorities differ from homepage:**

### High-Priority Issues

1. **Message mismatch** (ad promise ≠ landing headline)
   - Impact: Immediate bounce
   - Fix complexity: Low (rewrite headline)
   - Expected gain: +200%+

2. **No/weak social proof**
   - Impact: Trust barrier
   - Fix: Add 3-5 testimonials
   - Expected gain: +60-80%

3. **Generic CTAs**
   - Impact: Low urgency
   - Fix: Specific benefit CTAs
   - Expected gain: +200%+

4. **Navigation present** (if B2C/low-ticket)
   - Impact: Distraction/exits
   - Fix: Remove nav
   - Expected gain: +25-40%
...
Use this for rapid landing page audit:

```
[ ] Message match (ad → landing)
[ ] Hook zaujme do 3s
[ ] Problem stated with stakes
[ ] Solution directly addresses problem
[ ] 3+ specific testimonials with photos
[ ] Features → benefits translated
[ ] Money-back guarantee visible
[ ] 3-5 CTAs throughout page
[ ] Navigation removed (B2C) or minimal (B2B)
[ ] Mobile responsive
[ ] Load time <3s
[ ] Form fields <7 (if lead gen)
```
