...
This skill provides a systematic 7-step framework for creating high-converting product descriptions for e-commerce. It distinguishes between **Type A (standard/technical)** and **Type B (experiential/unique)** products, applies Otto Bohuš copywriting principles, integrates web copy best practices (testimonials, story, surprise elements, psychological triggers), and ensures SEO optimization and quality controls.
...
- ✅ Developing product page structure and SEO elements
...
- **PROČ (Why):** What's the brand story? (Cyrano Effect - especially for Type B products)
- **KAM (Goal):** What action do you want? (Add to cart, contact, learn more)
...
4. **Emoce pro typ B** - Zážitkové produkty potřebují emotivní příběh (Cyrano efekt)
...
## The Process: 7-Step Product Copy Framework

**IMPORTANT: Use TodoWrite to create todos for EACH step below.**

### Step 1: Rozřazení Produktu (Product Classification)

- [ ] Určit typ produktu: **(A) Standardní/technický** nebo **(B) Zážitkový/unikátní**
- [ ] Zdůvodnit klasifikaci na základě vstupů
...
**⚠️ Pravidlo:** Vyvaruj se klišé a prázdných frází i u typu B!

---

### Step 2: Průzkum Konkurence (Competitive Research)

- [ ] Prozkoumat 3–5 konkurenčních produktových stránek
- [ ] Sepsat jejich strukturu (sekce, pořadí, CTA)
- [ ] Identifikovat chybějící informace u konkurence
...
- FAQ založené na reálných obavách

**Psychologický princip:** **Sociální důkaz** - Pokud konkurence něco nedělá, můžeme vyniknout (z III. dílu + Web Copy That Sells)

---

### Step 3: Struktura Stránky (Page Structure)

- [ ] Vytvořit přehlednou strukturu sekcí v pořadí pro konverze

**Optimální struktura (11 sekcí):**

0. **Claim produktu** (volitelné - pro standalone/brand produkty)
   - Max 6 slov, **BEZ TEČKY!**
   - Libozvučný a originální
   - Př: "Káva, která vás probudí" / "Espresso za 30 sekund"
   - **Důležité:** Claim patří pod název produktu, ne jako microbenefit

1. **Microbenefit** (jedna věta nad foldem)
   - Př: "Ušetří vám 3 hodiny týdně – bez zvednutí telefonu"
   - **Hook technika:** Použij osvědčené hook typy (otázka, čísla, transformace)

2. **2–3 odrážky největších přínosů** (užitek, ne parametry)
   - ✅ "Vynesete sami do 3. patra (4,5 kg)"
   - ❌ "Lehký"

3. **Pro koho / scénář použití** (max. 3 věty)
   - Cílová skupina + situace použití

4. **Tabulka klíčových parametrů** (rozměry, materiál, výkon, kompatibilita)
   - Markdown tabulka, skenovatelná

5. **Omezení / upozornění** (jasně a viditelně)
   - ⚠️ Př: "Nevhodné pro indukci", "Funguje jen s Qi2"
   - **Důvod:** Nechceme vratky!

6. **Důvěryhodnost** (záruka, doručení, vrácení, certifikace)
   - **Triáda - Rezistence:** Předejít námitkám (z Web Copy That Sells)

7. **Testimonials / Reference** (sociální důkaz)
   - Min. 1-2 reference s fotkami
...
8. **Story / Příběh produktu** (volitelné - hlavně Type B)
   ...
   - **Cyrano efekt:** Emotivní obal kolem produktu
   - Př: "Inspirováno italskou babičkou, která 40 let dělala espresso v malé kavárně v Neapoli..."
   - **Kdy použít:** Type B produkty, unikátní příběh vzniku, brand story

9. **FAQ** (3–5 dotazů z reálných obav)
   - Long-tail dotazy pro SEO
...
### Step 4: Textace (Writing the Copy)

- [ ] Dodržet skenovatelnost (krátké odstavce, odrážky, mezititulky)
- [ ] Přidat captions k fotkám (měřítko, detail, reálné použití)
- [ ] Upozornit na klíčová omezení (viditelně!)
- [ ] Vytvořit 2 verze tónu: (1) věcná/technická, (2) brandová/emotivní
- [ ] Aplikovat Triáda framework pro přesvědčivější copy
...
> **Z Web Copy That Sells:** "Prodejní copy by měla aktivovat emoční oblasti mozku (pravá hemisféra)."

---

#### Triáda Framework (pro přesvědčivější copy)
...
#### Hook Techniky (pro Microbenefit)

**IMPORTANT:** Microbenefit by měl použít osvědčené hook typy z Instagram content.
...
#### Konverzační tón (Pište jak mluvíte)
...
- Jako byste to vysvětlovali kamarádovi

---

### Step 4.5: Psychologické triggery pro produktové stránky

**IMPORTANT: Aplikuj minimálně 2-3 triggery na každou produktovou stránku.**

- [ ] Vybrat 2-3 relevantní psychologické triggery
- [ ] Aplikovat je strategicky v copy a designu
- [ ] Ověřit, že triggery podporují benefit (ne manipulace)
...
### Step 5: SEO Výstup (SEO Elements)

- [ ] Navrhni Metatitle (do 60 znaků) s hlavním klíčovým slovem + benefit
- [ ] Navrhni Metadescription (do 155 znaků) = přínos + 1–2 parametry + výzva
- [ ] Navrhni 3–5 long-tail dotazů (FAQ) a krátké odpovědi
- [ ] Navrhni URL slug, H1, H2 mezititulky
...
- **Metadescription:** Přínos + parametry + urgence
  - Př: "Profesionální espresso za 15 sekund. 15 barů, PID kontrola, Dnes odešleme."
- **Kategorie/filtry:** Přirozený jazyk (jak lidé hledají)
- **Interní prolinkování:** Příslušenství, související kategorie, průvodce výběrem
- **Nekopíruj texty dodavatelů** - duplicita škodí SEO

**Volitelně:** Schema.org/Product (JSON-LD) pro rich snippets

---

### Step 6: Kontroly Kvality (Quality Controls)

- [ ] Sjednotit terminologii a jednotky měření
- [ ] Označit místa, kde chybí data nebo je potřeba potvrdit čísla
- [ ] Vysvětlit technické termíny (infobox nebo vysvětlivka)
- [ ] Navrhnout, co má být nad foldem na mobilu
- [ ] Přizpůsobit lokalizaci (CZ/EN, cm/inch)
...
### Step 7: Finální Výstup (Final Deliverables)
...
- **(d)** Tabulku parametrů (markdown tabulka)
- **(e)** FAQ (3–5 dotazů a odpovědí)
- **(f)** Metatitle, Metadescription, URL slug, H1/H2
- **(g)** Poznámky ke kreativitě a vizuálům (co vyfotit, jaké captions)
...
- **(l)** Surprise elements návrhy (prázdný košík, success message, out of stock)
- **(m)** Psychologické triggery použité (seznam 2-3 triggerů s vysvětlením aplikace)
- **(n)** P.S. sekce (pokud použita)
...
- Technický žargon bez vysvětlení
...
- **Pište jak mluvíte** - Konverzační tón, ne business speak
...
- **Testimonials struktura:** Celé jméno + město + konkrétní výsledek
...
- **PRObodni (krok 5):** Emoce, storytelling, vizualizace
...
- Kopíruješ text od dodavatele
- Píšeš parametry bez přínosů
...
4. Upozorni na omezení JASNĚ
5. Přepiš texty dodavatelů svými slovy
...
- **FAQ:** Long-tail SEO + zodpovězení obav = vyšší konverze
- **Triáda (Rezistence):** Předejít námitkám = vyšší trust

> **Z materiálů:** "Nechceme vratky, takže pokud je potřeba zákazníky upozornit na nějaké specifikum, udělej to a tak, aby to nepřehlédli."
...
- [Product Structure Template](./product-structure-template.md) - šablona pro rychlý start (TODO: create)

---

**Remember:** Short, scannable, precise. Benefits > features. Concrete > vague. No fluff. Test on real users.
